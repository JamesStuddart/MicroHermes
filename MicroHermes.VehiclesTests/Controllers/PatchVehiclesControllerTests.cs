...
namespace MicroHermes.VehiclesTests.Controllers
{
    public class PatchVehiclesControllerTests
    {
        ...
        public PatchVehiclesControllerTests()
        {
            ...
            _controller = new PatchVehiclesController(_vehicleCommands.Object, _vehicleQueries.Object, _vehicleEntityMapper.Object, _vehicleModelValidation.Object, _vehicleModelMapper.Object);
        }
    }
}